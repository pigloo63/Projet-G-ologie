...
const MineralField = ({ elementMineral }) => {
  return (
    <div>
      {elementMineral && (
        <div className="border rounded-3xl p-5 w-auto absolute top-[440px] left-[200px]">
          <div className="flex">
            <div className="flex">
              <div className="h-2">
          ...
          <div className="flex">
            <div>
              {elementMineral.imgMic && (
                <h2 className="font-bold mb-5">Image au Microscope</h2>
              )}
              {elementMineral.imgMic && (
                <img src={elementMineral.imgMic} alt="image du mineral" />
              )}
            </div>
            <div className="ml-[400px]">
              {elementMineral.imgDiagram && (
                <h2 className="font-bold mb-5">Diagram</h2>
              )}
              {elementMineral.imgDiagram && (
                <img src={elementMineral.imgDiagram} alt="image du mineral" />
              )}
            </div>
          </div>
        </div>
